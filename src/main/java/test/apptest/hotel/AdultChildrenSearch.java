...
public class AdultChildrenSearch extends BaseTest {
	...
	@Test(description = "by chr: C1309641 国内城市，选择大于两天的入离日期，2成人1儿童（未成年）搜索酒店", groups = { "Base" })
	public void DomesticdaysAdultChildrenSearch() throws Exception {
		logger.info("by chr: C1309641 国内城市，选择大于两天的入离日期，2成人1儿童（未成年）搜索酒店");
		new WebDriverWait(driver, 30).until(ExpectedConditions.elementToBeClickable(By.id("myctrip_hotel_icon"))).click();
		new WebDriverWait(driver, 30).until(ExpectedConditions.elementToBeClickable(By.id("tv_stay_in"))).click();
	    new WebDriverWait(driver, 30).until(ExpectedConditions.elementToBeClickable(By.id("hotel_destination_search_keyword_import"))).clear();
	    new WebDriverWait(driver, 30).until(ExpectedConditions.elementToBeClickable(By.id("hotel_destination_search_keyword_import")))
        ...
        //选择两天的日期
        new WebDriverWait(driver, 60).until(ExpectedConditions.elementToBeClickable(By.id("tvDepartMonth"))).click();
        acs.swipeToDown(driver);
   	    List<WebElement> days = driver.findElements(By.id("tv_day"));
   	    //Calendar c = Calendar.getInstance();
   	    //int date = c.get(Calendar.DATE);    
   	    //logger.info(date);
   	    for (int i=0;i<days.size();i++) 
   	    {
   	    	//logger.info(days.get(i));
   	    	String Date = days.get(i).getText();
   	    	logger.info(Date);
   	    	if(Date.equals("1"))
   	    	{
        		//Actions actions = new Actions(driver);
 				//actions.moveToElement(days.get(i+10));
   	    		logger.info(i);
 				days.get(i).click();
 				days.get(i+2).click();
 				break;
 				//actions.moveToElement(days.get(i+12));
   	    	}
   	    }
        ...
        try{
             ...
             {
             	String childagerange = driver.findElement(By.id("tv_age_range")).getText();
             	Assert.assertEquals("3 歲",childagerange);
             }
             logger.info("---C1309641 国内城市，选择大于两天的入离日期，2成人1儿童（未成年）搜索酒店验证通过---");
             
        }
        catch(Exception exception){
        	exception.printStackTrace();
        	logger.info("---C1309641 国内城市，选择大于两天的入离日期，2成人1儿童（未成年）搜索酒店验证失败---");
        }
        //返回详情页
        new WebDriverWait(driver, 30).until(ExpectedConditions.elementToBeClickable(By.id("tv_apply"))).click();
        //返回酒店列表页
	...
	@Test(description = "by chr: C1309642 海外城市，选择大于两天的入离日期，2成人1儿童（未成年）搜索酒店", groups = { "Base" })
	public void OverseasdaysAdultChildrenSearch() throws Exception {
		logger.info("by chr: C1309642 海外城市，选择大于两天的入离日期，2成人1儿童（未成年）搜索酒店");
		new WebDriverWait(driver, 30).until(ExpectedConditions.elementToBeClickable(By.id("myctrip_hotel_icon"))).click();
		new WebDriverWait(driver, 30).until(ExpectedConditions.elementToBeClickable(By.id("tv_stay_in"))).click();
	    new WebDriverWait(driver, 30).until(ExpectedConditions.elementToBeClickable(By.id("hotel_destination_search_keyword_import"))).clear();
	    new WebDriverWait(driver, 30).until(ExpectedConditions.elementToBeClickable(By.id("hotel_destination_search_keyword_import")))
      ...
      //选择两天的日期
        ...
        try{
             ...
             logger.info("---C1309642 海外城市，选择大于两天的入离日期，2成人1儿童（未成年）搜索酒店验证通过---");
             
        }
        catch(Exception exception){
        	exception.printStackTrace();
        	logger.info("---C1309642 海外城市，选择大于两天的入离日期，2成人1儿童（未成年）搜索酒店验证失败---");
        }
        //返回详情页
        new WebDriverWait(driver, 30).until(ExpectedConditions.elementToBeClickable(By.id("tv_apply"))).click();
        //返回酒店列表页

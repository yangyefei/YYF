...
public class OrderPrePay extends BaseTest {
    ...
    /**
     * @param i 0：CNY 1：USD 2: HKD 3: TWD 4: EUR 9: JPY 10:KRW 13: SGD
     */
    ...
    public void exchange(int i) {
        ...
        new WebDriverWait(driver, timeOutInSeconds).until(ExpectedConditions.elementToBeClickable(By.id("tv_filter")))
                .click();
        new WebDriverWait(driver, timeOutInSeconds).until(ExpectedConditions.elementToBeClickable(By.id("hotel_filter_checkbox_view_checkbox")));

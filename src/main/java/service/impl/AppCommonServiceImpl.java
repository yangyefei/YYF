...
//	      driver.findElementByName("立即登录").click();
	      new WebDriverWait(driver,60).until(ExpectedConditions.visibilityOfElementLocated(By.id("login_password"))).sendKeys(userPassWord);
	      new WebDriverWait(driver,60).until(ExpectedConditions.visibilityOfElementLocated(By.name("立即登录"))).click();
